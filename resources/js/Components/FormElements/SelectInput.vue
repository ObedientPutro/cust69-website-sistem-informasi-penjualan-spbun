...
const selectClasses = computed(() => {
    const base = "dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border bg-transparent px-4 py-2.5 pr-11 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3 transition-colors duration-200";
    ...
    const textColor = model.value ? 'text-gray-800 dark:text-white/90' : 'text-gray-400 dark:text-gray-400';
