            ...
            <div class="flex w-full flex-col flex-1 lg:w-1/2">
                ...
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto px-6 sm:px-0 mt-10 lg:mt-0">
                    <div>
                        ...
                        <div v-if="status" class="mb-4 text-sm font-medium text-success-500">
                            {{ status }}
                        </div>
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        :class="{ 'border-error-500 focus:border-error-500': form.errors.email }"
                                    />
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input
                                            ...
                                            :class="{ 'border-error-500 focus:border-error-500': form.errors.password }"
                                        />
                                        <span
                                ...
                                <div class="flex items-center justify-between">
                                    <label for="remember" class="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
                                        <div class="relative">
                                            ...
                                            <div :class="form.remember ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'" class="mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] transition-colors">
                                    ...
                                    <Link v-if="canResetPassword" :href="route('password.request')" class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">
                                        Forgot password?
                                    </Link>
                                </div>
                ...
                <div class="flex items-center justify-center z-1 relative">
                    ...
                    <div class="flex flex-col items-center max-w-xs relative z-10">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Sistem Informasi Penjualan SPBU-N<br>
